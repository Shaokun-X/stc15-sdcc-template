...
__sfr __at (0x9D) P1ASF;	//只写，模拟输入(AD或LVD)选择
...
__sfr __at (0xAF) IE2;	//STC12C5A60S2系列
...
__sfr __at (0xB5) IP2;	//STC12C5A60S2系列
__sfr __at (0xB6) IPH2;	//STC12C5A60S2系列
__sfr __at (0xB7) IPH;

__sfr __at (0xB8) IP;
__sfr __at (0xB9) SADEN;
__sfr __at (0xBA) P_SW2;
__sfr __at (0xBC) ADC_CONTR;	//带AD系列
__sfr __at (0xBD) ADC_RES;	//带AD系列
__sfr __at (0xBE) ADC_RESL;	//带AD系列
...
__sfr __at (0xCB) P6M1;	//	P5M1.n,P5M0.n 	=00--->Standard,	01--->push-pull
...
__sfr __at (0xE8) P6;
__sfr __at (0xE9) CL;	//
__sfr __at (0xEA) CCAP0L;	//PCA模块0的捕捉/比较寄存器低8位。
__sfr __at (0xEB) CCAP1L;	//PCA模块1的捕捉/比较寄存器低8位。
__sfr __at (0xEC) CCAP2L;	//PCA模块2的捕捉/比较寄存器低8位。
...
__sfr __at (0xF8) P7;
__sfr __at (0xF9) CH;
__sfr __at (0xFA) CCAP0H;		//PCA模块0的捕捉/比较寄存器高8位。
__sfr __at (0xFB) CCAP1H;		//PCA模块1的捕捉/比较寄存器高8位。
__sfr __at (0xFC) CCAP2H;		//PCA模块2的捕捉/比较寄存器高8位。
...
__sbit __at (0xA2) SPI_MISO_2;
__sbit __at (0xA1) SPI_SCLK_2;
...
__sbit __at (0xD8) CCF0;	//PCA 模块0中断标志，由硬件置位，必须由软件清0。
__sbit __at (0xD9) CCF1;	//PCA 模块1中断标志，由硬件置位，必须由软件清0。
__sbit __at (0xDA) CCF2;	//PCA 模块2中断标志，由硬件置位，必须由软件清0。
__sbit __at (0xDE) CR;	//1: 允许PCA计数器计数，必须由软件清0。
__sbit __at (0xDF) CF;	//PCA计数器溢出（CH，CL由FFFFH变为0000H）标志。PCA计数器溢出后由硬件置位，必须由软件清0。
